<?php
    ...
    if ($_POST['email'] == $_POST['conf'] AND $_POST['senha'] == $_POST['confsenha']) {
        ...
        //echo "Dados iguais!!";
        $_SESSION['ok'] = "<div class='alert alert-success rounded-4 mt-3 alert-dismissible' role='alert'>Usuário cadastrado com sucesso!</div>";
        echo "<meta http-equiv= 'refresh' content='0; URL=../index.php'/>";

    } else {
        $_SESSION['ok'] = "<div class='alert alert-danger rounded-4 mt-3 alert-dismissible' role='alert'>Dados não conferem!</div>";
