...
<?php
    ...
    if (empty($result)) {
        ...
        $_SESSION['ok'] = "<div font-family: 'Inter', sans-serif;' class='alert alert-danger rounded-4 mt-3 alert-dismissible' role='alert'>Usuário ou senha não encontrados!</div>";
